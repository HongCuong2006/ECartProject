...
!(function (global, factory) {
    if ("function" == typeof define && define.amd)
        ...
        var mod = {exports: {}};
        factory(global.jQuery, global.Site), (global.tablesDatatable = mod.exports);
    }
                    ...
                    return (
                        this.$table
                            .on("click", "a.save-row", function (e) {
                                e.preventDefault(), _self.rowSave($(this).closest("tr"));
                            })
                            .on("click", "a.cancel-row", function (e) {
                                e.preventDefault(), _self.rowCancel($(this).closest("tr"));
                            })
                            .on("click", "a.edit-row", function (e) {
                                e.preventDefault(), _self.rowEdit($(this).closest("tr"));
                            })

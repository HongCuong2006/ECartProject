...
(function (factory) {
    ...
    function _fnBuildAjax(oSettings, data, fn) {
        ...
        if (oSettings.fnServerData) {
            ...
            oSettings.jqXHR = $.ajax(
                $.extend(baseAjax, {url: ajax || oSettings.sAjaxSource})
            );
    ...
    _api_register(
        [_child_obj + ".show()", _child_mth + ".show()"],
        function (show) {
    ...
    _api_register(
        [_child_obj + ".remove()", _child_mth + ".remove()"],
        function () {
            __details_remove(this);
            return this;
        }
    ...
    var __cell_selector = function (settings, selector, opts) {
        ...
        var run = function (s) {
            ...
            return host.length
                ? [{row: host.data("dt-row"), column: host.data("dt-column")}]
                : [];
        };

    ...
    return (function e(t, n, r) {
        ...
        2: [function (require, module, exports) {
            ...
            module.exports = [{
                ...
                filter: ['del', 's', 'strike'], replacement: function (content) {
                    return '~~' + content + '~~'
                }
            }, {
                ...
                filter: ['th', 'td'], replacement: function (content, node) {
                    return cell(content, node)
                }
            }, {
                filter: 'tr', replacement: function (content, node) {
                    var borderCells = ''
                ...
                filter: 'table', replacement: function (content) {
                    return '\n\n' + content + '\n\n'
                }
            }, {
                filter: ['thead', 'tbody', 'tfoot'], replacement: function (content) {
                    return content
                }
            }, {
                filter: function (node) {
        ...
        4: [function (require, module, exports) {
            'use strict'
            module.exports = [{
                filter: 'p', replacement: function (content) {
                    return '\n\n' + content + '\n\n'
                }
            }, {
                filter: 'br', replacement: function () {
                ...
                filter: ['h1', 'h2', 'h3', 'h4', 'h5', 'h6'], replacement: function (content, node) {
                ...
                filter: ['em', 'i'], replacement: function (content) {
                    return '_' + content + '_'
                }
            }, {
                filter: ['strong', 'b'], replacement: function (content) {
                    return '**' + content + '**'
                }
            }, {
                filter: function (node) {
                ...
                filter: 'img', replacement: function (content, node) {
                    var alt = node.alt || ''
                ...
                filter: 'blockquote', replacement: function (content) {
                    content = content.trim()
                ...
                filter: 'li', replacement: function (content, node) {
                ...
                filter: ['ul', 'ol'], replacement: function (content, node) {
                    var strings = []
                    for (var i = 0; i < node.childNodes.length; i++) {
